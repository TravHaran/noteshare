...
Revision ID: 8a47dd58b2b1
Revises: 2338b1a79f6c
Create Date: 2022-08-17 22:17:30.416404
...
revision = '8a47dd58b2b1'
down_revision = '2338b1a79f6c'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['invitee'], ['users.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['librarian'], ['users.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['library_id'], ['libraries.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
